...
class Load_Transactions_via_Pandas:
    ...
    def __init__(self):
        ...
        self.datasource = "C:/Users/Bob/Documents/money/budget/current budget info.xlsx"
        ...
        self.budget_amounts = pd.read_excel(self.datasource, "Budget Amounts")
        super_category = ""
        ...
        #
        self.actuals = pd.read_excel(self.datasource, "Transactions")
