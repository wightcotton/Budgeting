...
class Load_Transactions_via_Pandas:
    ...
    def __init__(self):
        ...
        self.budget_amounts = pd.read_excel("C:/Users/Bob/Documents/money/budget/current budget info.xlsx", "Budget Amounts")
        super_category = ""
        ...
        #
        self.actuals = pd.read_excel("C:/Users/Bob/Documents/money/budget/current budget info.xlsx", "Transactions")
        ...
        for index, row in self.actuals.iterrows():
            ...
            if category not in self.ignore_list and row["Date"] >= start_date :
                try:
                    ...
                    readable_row = str(row["Date"].day) + " | " + row["Description"] + " | " + str(row["Amount"]) + " " + tran_type_text
